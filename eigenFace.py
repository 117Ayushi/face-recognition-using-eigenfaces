...
# This give absolute path in Linux may create problem in windows system
dirname = os.path.dirname(os.path.abspath(__file__))
IMAGE_DIR = os.path.join(dirname, 'training_data')

# All images are supposed to be the same size, say, N*L
# IMAGE_DIR = "/home/zee7han/Documents/python/Face-recognition-using-eigenfaces/training_data"
